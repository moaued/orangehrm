...
public class EditUserPage extends PageBase {
	...
	private  By editicone=  By.xpath("(//i[contains(@class,'oxd-icon bi-pencil-fill')])[1]");
	...
	private By chooseFile=By.cssSelector("//input[contains(@type,'file')]");
	  public void Edituser(String street) {
